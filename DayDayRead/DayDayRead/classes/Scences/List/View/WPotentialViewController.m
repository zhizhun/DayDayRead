...
@interface WPotentialViewController ()

@end

@implementation WPotentialViewController
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        list.array = @[WPOTEN_WEEK_URL, WPOTEN_MOUTH_URL, WPOTEN_ALL_URL];
    }
    return self;
}
