...
@interface PotentialViewController ()

@end

@implementation PotentialViewController
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        list.array = @[POTEN_WEEK_URL, POTEN_MOUTH_URL, POTEN_ALL_URL];
    }
    return self;
}
