...
- (void)initView {
   ...
   //每两个item的最小间距 (水平滚动)
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-60) collectionViewLayout:self.flowLayout];
